...
- n-0045 2026-09-20 #gotcha @docs/wiki/pages/concept-to-sprite.md @src/pixellab_cli/commands/character.py — a precise character needs both a large reference, up to the 256 ceiling, and an enriched description; either one thin comes back roughly right, which is only visible across eight paid frames
